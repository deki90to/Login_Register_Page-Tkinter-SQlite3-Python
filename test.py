...
def about():
    tkinter.messagebox.showinfo ("Registation", "This is a registration page")
...
def second_window():
    ...
    def login():
        ...
        for i in read:
            ...
            tkinter.messagebox.showinfo ("Failed", "Wrong UserName Or Password")


    label_w2 = Label (window, text= 'Enter your FirstName and Password', bg = '#004038', fg = 'white', relief = 'raised', font = ('arial', 12, 'bold'))
    label_w2.place (x = 20, y = 100)

    label_w3=Label (window, text = 'FirstName', bg = '#004038', fg = 'white', relief = 'raised')
    label_w3.place (x = 30, y = 200)
    entry_w3 = Entry (window ,textvar = ent_lg_fn)
    entry_w3.place (x = 100, y = 200)

    label_w4 = Label (window, text = 'Password', bg = '#004038', fg = 'white', relief = 'raised')
    label_w4.place (x = 30, y = 250)
    entry_w4 = Entry (window, textvar = ent_lg_pass)
...
label4 = Label (root, text = 'E-mail', bg = '#004038', fg = 'white', relief = 'raised', font = (20))
...
entry_pw = Entry (root, textvar = ent_pass)
